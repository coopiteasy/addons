...
class PosSession(models.Model):
    ...
    def _search_customer_wallet_order_lines(self, sale_key):
        """Find an existing pos order line from a dictionary representation."""
        # TODO: Instead of doing ORM search, we manually loop through everything
        # to find a match. This is probably terrible for performance.
