...
class MRPProductProduce(models.TransientModel):
    ...
    def _create_production_lot(self):
        ...
        for prod_order in mo_obj.browse(self._context['active_id']):
            prod_lot = prod_lot_obj.search([('name','=',prod_order.brew_order_name),
    ...
    lot_id = fields.Many2one('stock.production.lot', 'Lot', default=_create_production_lot) #Should only be visible when it is consume and produce mode