##############################################################################
#
#    Hardware Cashlogy Automatic Cashdrawer module for Odoo
...
This module adds support for automatic cashdrawer from the
Cashlogy/AzkoyenGroup. This module is designed to
