...
class Building(models.Model):
    ...
    surface_hm = fields.Integer(
        string='Surface HM',
        required=False,
        help='m²')
    housings_hm = fields.Integer(
        string='Number of HM housings',
        required=False)
    ...
    housings_lup = fields.Integer(
        string='Number of LUP housings',
        required=False)

    surface_zdloc = fields.Integer(
        string='Surface ZDLOC',
        required=False,
        help='m²')
    housings_zdloc = fields.Integer(
        string='Number of ZDLOC housings',
        required=False)

    ddp_start = fields.Date(
        string="Start of 'droit distinct et permanent' (DDP)",
        required=False)
